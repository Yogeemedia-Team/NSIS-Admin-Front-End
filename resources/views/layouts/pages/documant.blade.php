...
<html lang="en">
<head>
	<title>NSIS - Documentation For Software Projects</title>
	...
	<!-- FontAwesome JS-->
	<script defer src="assets/document/fontawesome/js/all.min.js"></script>

	<!-- Plugins CSS -->
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.15.2/styles/atom-one-dark.min.css">
	<link rel="stylesheet" href="assets/document/plugins/simplelightbox/simple-lightbox.min.css">

	<!-- Theme CSS -->
	<link id="theme-style" rel="stylesheet" href="assets/document/css/theme.css">
...
<body class="docs-page">
		...
		<div class="branding docs-branding">
			<div class="container-fluid position-relative py-2">
				<div class="docs-logo-wrapper">
					...
					<div class="site-logo"><a class="navbar-brand" href="/dashboard"><img class="logo-icon me-2"
								src="assets/document/images/nsis.png" alt="logo"><span class="logo-text">NSIS</span></a></div>
				</div><!--//docs-logo-wrapper-->
				<!-- <div class="docs-top-utilities d-flex justify-content-end align-items-center">
					
					<a href="/dashboard"
						class="btn btn-primary d-none d-lg-flex">Home</a>
				</div> -->
                <!--//docs-top-utilities-->
			</div><!--//container-->
		</div><!--//branding-->
			...
			<div class="container">
				<article class="docs-article" id="section-1">
					<header class="docs-header">
						<h1 class="docs-heading">Introduction <span class="docs-time">Last updated: 2023-12-20</span>
						</h1>
	...
	<!-- Javascript -->
	<script src="assets/document/plugins/popper.min.js"></script>
	<script src="assets/document/plugins/bootstrap/js/bootstrap.min.js"></script>


	<!-- Page Specific JS -->
	<script src="assets/document/plugins/smoothscroll.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.15.8/highlight.min.js"></script>
	<script src="assets/document/js/highlight-custom.js"></script>
	<script src="assets/document/plugins/simplelightbox/simple-lightbox.min.js"></script>
	<script src="assets/document/plugins/gumshoe/gumshoe.polyfills.min.js"></script>
	<script src="assets/document/js/docs.js"></script>
