                ...
                <ul class="list-group">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Addmission Status:</strong> &nbsp; <span class="badge badge-warning text-dark">Pending</span></li>
                        </div>
                    </div>
                </ul>
            </div>
