    ...
    <div class="container-fluid body_content py-4">
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="text-end">
                    <a href="{{ route('add_enrollment') }}" class="btn btn-primary mb-0"><i class="fa-solid fa-plus me-2"></i> Add New</a>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataTable" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th class="px-2">Grade/Class</th>
                                <th class="px-2">Name in Full</th>
