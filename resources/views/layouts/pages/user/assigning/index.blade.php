    ...
    <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                {{ Breadcrumbs::render('user_assigning') }}
    ...
    <div class="container-fluid body_content py-4">
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="text-end">
                    <a href="{{ route('add_user_assigning') }}" class="btn btn-primary mb-0"><i class="fa-solid fa-plus me-2"></i> Add New</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="dataTable" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="px-2">Activity</th>
                                <th class="px-2">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($user_assigning as $user_assigning)
                            <tr>
                                <td>Sample User</td>
                                <td>Sample level</td>
                                <td>Sample Role</td>
                                ...
                                <td class="d-flex">
                                    ...
                                    @if($user_assigning['id'] !== null)
                                    <form id="deleteForm{{ $user_assigning['id'] }}" action="{{ route('user_assigning_delete', ['id' => $user_assigning['id']]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button style="border:2px solid #c1476e" type="button" class="btn btn-danger m-0 py-1 px-2" onclick="confirmDelete('{{ $user_assigning['id'] }}')">
...
<script>
    function confirmDelete(userAssigningId) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                ...
                document.getElementById('deleteForm' + userAssigningId).submit();
            }
