    ...
    <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-2 top-1 px-0 mx-2 shadow-none border-radius-xl z-index-sticky side-bar-bg" id="navbarBlur" data-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                {{ Breadcrumbs::render('user_levels') }}
    ...
    <div class="container-fluid body_content py-4">
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="text-end">
                    <a href="{{ route('add_user_level') }}" class="btn btn-primary mb-0"><i class="fa-solid fa-plus me-2"></i> Add New</a>
                </div>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($userlevels as $userlevel)
                             <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form id="deleteForm{{ $userlevel['id'] }}" action="{{ route('user_level_delete', ['id' => $userlevel['id']]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button style="border:2px solid #c1476e" type="button" class="btn btn-danger m-0 py-1 px-2" onclick="confirmDelete('{{ $userlevel['id'] }}')">
    ...
    function confirmDelete(userLevelId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                document.getElementById('deleteForm' + userLevelId).submit();
            }
