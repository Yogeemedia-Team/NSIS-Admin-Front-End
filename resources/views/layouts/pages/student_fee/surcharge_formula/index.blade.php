    ...
    <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                {{ Breadcrumbs::render('surcharge_formula') }}
    ...
    <div class="container-fluid body_content py-4">
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="text-end">
                    <a href="{{ route('add_surcharge_formula') }}" class="btn btn-primary mb-0"><i class="fa-solid fa-plus me-2"></i> Add New</a>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataTable" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th class="px-2">Surcharge Type</th>
                                <th class="px-2">Penalty 1 </th>
                                <th class="px-2">Penalty 2 </th>
                                <th class="px-2">Penalty 3 </th>
...
<script>
    function confirmDelete(surchargeFormulaId) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                ...
                document.getElementById('deleteForm' + surchargeFormulaId).submit();
            }
