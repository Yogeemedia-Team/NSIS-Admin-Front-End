    ...
    <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                {{ Breadcrumbs::render('monthly_fee') }}
    ...
    <div class="container-fluid body_content py-4">
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="text-end">
                    <a href="{{ route('add_monthly_fee') }}" class="btn btn-primary mb-0"><i class="fa-solid fa-plus me-2"></i> Add New</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form id="deleteForm{{ $monthly_fee['id'] }}" action="{{ route('monthly_fee_delete', ['id' => $monthly_fee['id']]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button style="border:2px solid #c1476e" type="button" class="btn btn-danger m-0 py-1 px-2" onclick="confirmDelete('{{ $monthly_fee['id'] }}')">
...
<script>
    function confirmDelete(monthlyFeeId) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                ...
                document.getElementById('deleteForm' + monthlyFeeId).submit();
            }
