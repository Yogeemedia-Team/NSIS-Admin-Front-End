            ...
            <div class="card-header pt-1 px-3">
                <div class="row bg-secondary py-2 px-1 rounded-4">
                    <div class="col-md-6 align-self-center">
                        <h5 class="font-weight-bolder text-white mb-0">Payment Delaied Student Report</h5>
                    </div>
                ...
                <div id="hiddenContent" class="d-none">
                    ...
                    <hr class="bg-black my-1">
                        <div class="row align-self-center text-center">
                            <p class="mb-0 fs-5 text-black text-center fw-bold text-capitalize">Payment Delaied Student Report</p>
                        </div>
                    <div class="row px-1 invoice-address py-1">
                        <div class="col-md-6 text-start">
                            <p class="mb-0 fs-6 text-black ">Year/Grade/Class: <span id="lblyear" class="fw-bold"></span></p>
...
<script>
    $(document).ready(function() {
        ...
        $('#searchForm').submit(function(event) {
            ...
            var endPoint = 'reports/payment_delaied?sd_year_grade_class_id=' +$('[name="sd_year_grade_class_id"]').val();
        ...
        $("#downloadButton").click(function() {
            ...
            $("#lblyear").text($('[name="sd_year_grade_class_id"] option:selected').text());

            var content = document.getElementById("PaymentSummery");
            html2pdf(content, {
                margin: 10,
                filename: 'payment_delaied_student.pdf',
                image: {
                    type: 'jpeg',
                    quality: 0.98
                },
