    ...
    <div class="container-fluid body_content py-4">
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="text-end">
                    <a href="{{ route('add_grade') }}" class="btn btn-primary mb-0"><i class="fa-solid fa-plus me-2"></i> Add New</a>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form id="deleteForm{{ $grade['id'] }}" action="{{ route('grade_delete', ['id' => $grade['id']]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button style="border:2px solid #c1476e" type="button" class="btn btn-danger m-0 py-1 px-2" onclick="confirmDelete('{{ $grade['id'] }}')">
